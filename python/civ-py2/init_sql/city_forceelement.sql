...
SELECT pg_catalog.setval('city_forceelement_id_seq', 16, true);
...
INSERT INTO city_forceelement (id, name, code, building_element_id, level, speed, food, wood, ore, gold, "time") VALUES (1, '狼狗', 'lang_gou', 24, 3, 4, 1, 1, 1, 1, 11);
INSERT INTO city_forceelement (id, name, code, building_element_id, level, speed, food, wood, ore, gold, "time") VALUES (2, '斗牛', 'dou_niu', 24, 2, 10, 22, 22, 22, 22, 222);
INSERT INTO city_forceelement (id, name, code, building_element_id, level, speed, food, wood, ore, gold, "time") VALUES (3, '战马', 'zhan_ma', 24, 1, 4, 1, 1, 1, 1, 11);
INSERT INTO city_forceelement (id, name, code, building_element_id, level, speed, food, wood, ore, gold, "time") VALUES (4, '战象', 'zhan_xiang', 24, 4, 4, 4, 4, 4, 4, 4);
...
INSERT INTO city_forceelement (id, name, code, building_element_id, level, speed, food, wood, ore, gold, "time") VALUES (6, '战兽', 'zhang_shou', 24, 5, 4, 4, 4, 4, 4, 4);
INSERT INTO city_forceelement (id, name, code, building_element_id, level, speed, food, wood, ore, gold, "time") VALUES (5, '海豚', 'hai_tun', 24, 1, 22, 22, 22, 22, 22, 222);
